...
const EditIntern = () => {
  ...
  const api = APP_URL + "api/edit-interns/";
        ...
        <Row className="justify-content-center">
          <Col lg="8">
            <div className="glass-shade">
              ...
              <Card>
                <CardBody>
                  <h2 className="card-title text-center mb-4">UPDATE INTERN</h2>
                  <form onSubmit={handleEdit}>
                    <Row>
                      ...
                      <div className="mb-3">
                        ...
                        {/* Add more fields here for the left side */}
                      </Col>
                      <Col md="6">
                      <div className="mb-3">
